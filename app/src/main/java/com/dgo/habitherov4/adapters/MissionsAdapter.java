...
public class MissionsAdapter extends RecyclerView.Adapter<MissionsAdapter.MissionViewHolder> {
    ...
    // Interfaz para manejar interacciones con misiones
    ...
    class MissionViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Mission mission) {
            ...
            // NOTA: Antes se mostraba el texto "Completado" pero cambié de oinión. Lo mantengo
            // porque a título personal quiero seguir experimentando después del TFG.
            ...
            // Configurar fondo .png según dificultad
            ...
            // NOTA: Esto de momento no lo usamos
//            if (mission.isCompleted()) {
...
//            }
        ...
        // Metodo para dar formato al tiempo restante
        ...
        // Detiene el temporizador/cuenta regresiva que está ejecutándose
